const copy = {
  ...
  en: {
    ...
    facts: [['Instructor', 'To be announced'], ['Class time', 'To be announced'], ['Location', 'To be announced']],
    ...
    announcements: [
      ...
      ['TBD', 'First lecture', 'The class time and room will be posted here once confirmed.'],
    ],
    informationTitle: 'Course information', informationKicker: 'At a glance',
    information: [
      ['Instructor', 'To be announced'], ['Teaching assistant', 'To be announced'], ['Class time', 'To be announced'],
      ['Location', 'To be announced'], ['Office hours', 'To be announced'], ['Course group', 'To be announced'],
